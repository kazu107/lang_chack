...
const languages = {
    python: {
        command: '..\\exec_env\\Python\\Python311\\python.exe', // 例: '/usr/bin/python3' または 'C:\\Python39\\python.exe'
        args: (scriptPath) => [scriptPath],
        scriptPath: path.join(__dirname, 'script.py'),
    ...
    cpp: {
        ...
        scriptPath: path.join(__dirname, 'script.cpp'),
